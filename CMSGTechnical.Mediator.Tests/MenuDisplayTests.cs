...
public class MenuDisplayTests : BunitContext
{
	...
	public void Home_Should_Render_Menu_Items_Grouped_By_Category()
	{
		var menuItems = new[]
		{
		new MenuItemDto { Id = 1, Name = "Burger", Price = 5, Category = "Food" },
		new MenuItemDto { Id = 2, Name = "Pizza",  Price = 8, Category = "Food" },
		new MenuItemDto { Id = 3, Name = "Cola",   Price = 2, Category = "Drinks" }
	};
		...
		cut.Markup.Should().Contain("Drinks");

		cut.Markup.Should().Contain("Burger");
		cut.Markup.Should().Contain("Pizza");
		cut.Markup.Should().Contain("Cola");
	}
